  ...
  return (
    ...
    <div className="flex flex-1">
      ...
      <div className="w-1/2 flex flex-col justify-center px-10 text-white">
        ...
        <p className="text-xl mb-6">LA MEJOR FORMA DE <span className="text-primary">RESERVAR</span> TU CANCHA</p>
        ...
        <div className="container mx-auto grid grid-cols-2 gap-8">
          ...
          <div>
            ...
            <ol className="list-decimal space-y-4 pl-6">
              ...
              <li>
                <strong>Reservá un turno:</strong> Seleccioná el horario y cancha de tu preferencia.
              </li>
              <li>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-3 gap-8">
            {/* Columna 1 */}
            <div>
              <h4 className="font-bold mb-2">Gestión de Agenda</h4>
              <p>Gestiona tu agenda de manera fácil y segura.</p>
              <h4 className="font-bold mt-4 mb-2">Sanción de Jugadores</h4>
              <p>Sanciona jugadores según las reglas de tu cancha.</p>
              <h4 className="font-bold mt-4 mb-2">Gestión de cajas</h4>
              <p>Controla los ingresos y egresos con transparencia.</p>
            </div>

            {/* Columna 2 */}
            <div>
              <h4 className="font-bold mb-2">Siempre Disponible</h4>
              <p>Accede desde cualquier dispositivo en cualquier lugar.</p>
              <h4 className="font-bold mt-4 mb-2">Múltiples Sesiones</h4>
              <p>Controla tu negocio sin importar dónde estés.</p>
              <h4 className="font-bold mt-4 mb-2">Pago Anticipado</h4>
            ...
            <div>
              ...
              <h4 className="font-bold mt-4 mb-2">Verificación de cuentas</h4>
              <p>Verifica los usuarios para mayor seguridad.</p>
              <h4 className="font-bold mt-4 mb-2">Promoción del complejo</h4>
